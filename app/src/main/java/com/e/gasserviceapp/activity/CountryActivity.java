    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View view) {
                ...
                else
                {
                    ...
                    PhoneAuthOptions options=PhoneAuthOptions.newBuilder(firebaseAuth)
                            ...
                            .setActivity(CountryActivity.this)
        ...
        mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onCodeSent(@NonNull String s, @NonNull PhoneAuthProvider.ForceResendingToken forceResendingToken) {
                ...
                codesent=s;
                Intent intent=new Intent(CountryActivity.this,OtpAuthentication.class);
...
//            Intent intent=new Intent(CountryActivity.this,SigninActivity.class);
//            Intent intent=new Intent(CountryActivity.this,MainActivity.class);
