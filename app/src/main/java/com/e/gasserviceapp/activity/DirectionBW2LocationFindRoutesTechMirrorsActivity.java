...
public class DirectionBW2LocationFindRoutesTechMirrorsActivity extends FragmentActivity implements OnMapReadyCallback,
...
//        setContentView(R.layout.activity_main);
        ...
        setContentView(R.layout.activity_near_by_fuel_gas_centers_map);
...
//        SupportMapFragment mapFragment1=(SupportMapFragment) getSupportFragmentManager().findFragmentById(R.id.map);
    ...
    public void Findroutes(LatLng Start, LatLng End)
    {
        if(Start==null || End==null) {
            Toast.makeText(DirectionBW2LocationFindRoutesTechMirrorsActivity.this,"Unable to get location", Toast.LENGTH_LONG).show();
        }
        else
        {
...
//        Findroutes(start,end);
    ...
    public void onRoutingStart() {
        Toast.makeText(DirectionBW2LocationFindRoutesTechMirrorsActivity.this,"Finding Route...",Toast.LENGTH_LONG).show();
    }
