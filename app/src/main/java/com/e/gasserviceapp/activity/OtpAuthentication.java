...
//                Intent intent=new Intent(OtpAuthentication.this,SigninActivity.class);
...
//                    Intent intent=new Intent(OtpAuthentication.this, MainActivity.class);
                    //Intent intent=new Intent(OtpAuthentication.this, DashboardNearbyFuelStation.class);
//                    Intent intent=new Intent(OtpAuthentication.this, ProfileActivityChat1.class);
                    startActivity(intent);
                    finish();
                }
                else
