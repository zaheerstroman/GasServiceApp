...
import com.e.gasserviceapp.UserModel;
import com.e.gasserviceapp.constant.AllConstant;
import com.e.gasserviceapp.databinding.ActivitySignUpBinding;
import com.e.gasserviceapp.databinding.ActivitySignUpGasBinding;
...
public class SignUpActivityGas extends AppCompatActivity {
//    setContentView(R.layout.activity_sign_up_gas);

    private ActivitySignUpGasBinding binding;
...
//        getPackageManager().getLaunchIntentForPackage("com.android.chrome");
        ...
        binding = ActivitySignUpGasBinding.inflate(getLayoutInflater());
...
//                    UsersRef.child(CurrentUserID).addValueEventListener(new ValueEventListener() {
                            ...
                            image.addOnCompleteListener(new OnCompleteListener<Uri>() {
                                ...
                                public void onComplete(@NonNull Task<Uri> imageTask) {
                                    ...
                                    if (imageTask.isSuccessful()) {
                                                ...
                                                addOnCompleteListener(new OnCompleteListener<Void>() {
                                                    ...
                                                    public void onComplete(@NonNull Task<Void> task) {
                                                        ...
                                                        if (task.isSuccessful()) {
                                                                            ...
                                                                            firebaseAuth.getCurrentUser().sendEmailVerification()
                                                                                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                                                                                        ...
                                                                                        public void onSuccess(Void aVoid) {
                                                                                            ...
                                                                                            Toast.makeText(SignUpActivityGas.this, "Verify email", Toast.LENGTH_SHORT).show();
                                                                                            onBackPressed();
                                                                                        }
                                                                                    });
                                                            ...
                                                            Toast.makeText(SignUpActivityGas.this, "Update Profile" + task.getException(), Toast.LENGTH_SHORT).show();
                                                        }
                                                    }
                                                });
                                        ...
                                        Toast.makeText(SignUpActivityGas.this, "Image Path" + imageTask.getException(), Toast.LENGTH_SHORT).show();
                                    }
                                }
                            });
                    ...
                    Toast.makeText(SignUpActivityGas.this, "" + singUp.getException(), Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
